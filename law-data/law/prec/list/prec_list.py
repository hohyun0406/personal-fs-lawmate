...
# Open API URL 템플릿
url_template = "https://www.law.go.kr/DRF/lawSearch.do?OC=hh7769&target=prec&type=XML&display=100&JO=형법&page={}"

# CSV 파일 생성
csv_file = open('criminal_prec_list.csv', 'w', newline='', encoding='utf-8')
...
print("모든 페이지의 CSV 데이터가 criminal_prec_list.csv 파일에 저장되었습니다.")