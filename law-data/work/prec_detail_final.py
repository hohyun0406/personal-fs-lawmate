...
input_csv_file = 'criminal_procedure_prec_list.csv'
...
# CSV 파일 작성
output_csv_file = 'criminal_procedure_prec_detail.csv'
...
print("CSV 파일 작성 완료: criminal_procedure_prec_detail.csv")
